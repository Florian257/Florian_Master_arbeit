...
//print n
	for(i=0;i<(n/20);i+=1)
	SummeW [i]= Summe[i]*MedianEnergy[i]*2
	endfor
...
above0Electrons=18
//Fragt nach dem timedelay			
		make /N=(numpnts(w)-15) /O reduced_w
reduced_w = w[p+15]
n=(999-15)
		make /N=(n/20) /O Summe
		make /N=(n/20) /O MedianEnergy
...
Killwaves reduced_w Summe MedianEnergy EnergyIntHoles EnergyIntHolesx H0 H1 H2 H3 H4 H5 H6 H7 H8 H9 H10 H11 H12 EnergyIntElectrons EnergyIntElectronsx E0 E1 E2 E3 E4 E5 E6 E7 E8 E9 E10 E11 E12 E13 E14 E15 E16 E17 SummeW EnergyIntElectronsW
//Print "FinishNo"
SetDatafolder ::
endif
End
